...
import { Query_User, Get_All_Products, Get_Sold_Auctions } from "../../utils/queries";
...
function Home() {
   ...
   const { loading: soldProductsLoading, data: soldProductsData } =  useQuery(Get_Sold_Auctions);
   ...
   useEffect(() => {
      if (
         ...
         dispatch({ type: GET_SOLD_PRODUCTS, payload: soldProductsData.recentlySoldAuctions})
      }
   }, [productsLoading, userLoading, dispatch]);
